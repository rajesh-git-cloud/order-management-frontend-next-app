...
const getOrders = async (page = 1, pageSize = 10, search, customer, statuses, sortBy, sortDirection)=>{
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get("/orders", {
        params
    });
};
const getNextOrderNo = async ()=>{
    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get("/orders/next-order-no");
    return res.data.orderNo;
};
const createOrder = (data)=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("/orders", data);
const updateOrder = (id, data)=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].put(`/orders/${id}`, data);
const deleteOrder = (id)=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].delete(`/orders/${id}`);
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__301cb0de._.js.map