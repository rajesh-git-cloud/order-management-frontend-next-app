...
function EditOrderDialog({ open, onClose, order, refreshData }) {
    ...
    const handleUpdate = async ()=>{
        ...
        try {
            ...
            setLoading(true);
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$orders$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateOrder"])(order.id, form);
            ...
            if (err instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].ZodError) {
                const fieldErrors = {};
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Update failed");
            }
        } finally{
            setLoading(false);
        }
...
function AddOrderDialog({ open, onClose, refreshData }) {
    ...
    const handleSave = async ()=>{
        setErrors({});
        try {
            __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$orders$2f$components$2f$validation$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["orderSchema"].parse(form);
            setLoading(true);
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success("Order created");
            onClose();
            refreshData();
        } catch (err) {
            if (err instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].ZodError) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2564773b._.js.map