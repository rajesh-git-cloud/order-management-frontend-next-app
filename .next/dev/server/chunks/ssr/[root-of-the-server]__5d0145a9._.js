...
================================ */ const api = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].create({
    baseURL: `${("TURBOPACK compile-time value", "http://localhost:4000")}/orders`,
    headers: {
...
// ✅ Global response interceptor to handle invalid/expired token
...
const createOrder = (data)=>api.post("", data);
const updateOrder = (id, data)=>api.put(`/${id}`, data);
const deleteOrder = (id)=>api.delete(`/${id}`);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5d0145a9._.js.map