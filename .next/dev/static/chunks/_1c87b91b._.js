...
function OrdersPage() {
    ...
    const [pageSize, setPageSize] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(10); // dynamic
    ...
    const fetchOrders = async (pageNumber = page, size = pageSize)=>{
        setLoading(true);
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$orders$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getOrders"])(pageNumber, size);
 ...
 //   );
 // }
_s(OrdersPage, "2kuhXi+Zg6VlXBcVFay+7730nB0=");
_c = OrdersPage;
var _c;
...
//# sourceMappingURL=_1c87b91b._.js.map