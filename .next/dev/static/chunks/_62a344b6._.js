...
const OrdersTable = ({ data, page, pageSize, total, loading, onPageChange, refreshData, columns, sortField, sortDir, setSortField, setSortDir })=>{
 ...
 //   const [columnFilters, setColumnFilters] = React.useState<any[]>([]); // column filters state
 ...
 //   };
 //   return (
 //     <div className="rounded-md border p-2 space-y-2 relative">
 ...
 //           value={
 //             (columnFilters.find((f) => f.id === "customerName")?.value as string) || ""
 //           }
 //           onChange={(e) => {
 //             const value = e.target.value;
 //             setColumnFilters((prev) => [
 //               ...prev.filter((f) => f.id !== "customerName"),
 //               ...(value ? [{ id: "customerName", value }] : []),
 //             ]);
 //           }}
 //           className="max-w-xs"
 //         />
 //         {/* Example: Status multi-select */}
 //         <div className="flex gap-2 items-center">
 //           {["OPEN", "PENDING", "INPROGRESS", "COMPLETED", "CANCELLED"].map((status) => {
 ...
 //                     if (checked) newStatuses.push(status);
 //                     setColumnFilters((prev) => [
 //                       ...prev.filter((f) => f.id !== "status"),
 //                       ...(newStatuses.length > 0 ? [{ id: "status", value: newStatuses }] : []),
 //                     ]);
 //                   }}
 //                 />
 ...
 //           Active Filters:
 //           {columnFilters.map((f) => (
 //             <span key={f.id} className="bg-gray-100 px-2 py-1 rounded">
 //               {f.id}: {Array.isArray(f.value) ? f.value.join(", ") : f.value}
 //             </span>
 //           ))}
 //         </div>
 //       )}
 ...
 //   onPageChange: (page: number) => void;
 //   refreshData: () => void;
 //   columns: any; // you can type this more strictly with ColumnDef<Order>[]
 // }
 // export const OrdersTable: React.FC<OrdersTableProps> = ({
 //   data,
 //   page,
 ...
 //           ) : (
 //             <TableRow>
 //               <TableCell colSpan={columns.length}>No orders found</TableCell>
 //             </TableRow>
 //           )}
 //         </TableBody>
 //       </Table>
...
const getNextOrderNo = async ()=>{
    const res = await api.get("/next-order-no");
...
function OrdersPage() {
 ...
 // import { AddOrderDialog } from "./orders/components/add-order-dialog";
 // import { Button } from "@/components/ui/button";
 ...
 //       <button
 //         type="button"
 //         className="border rounded px-3 py-1 text-sm w-48 text-left"
 //         onClick={() => setOpen(!open)}
 //       >
 //         {selected.length > 0 ? selected.join(", ") : "Select status"}
 //       </button>
 //       {open && (
 //         <div className="absolute z-10 mt-1 w-48 bg-white border rounded shadow-lg max-h-60 overflow-auto">
 //           {options.map((option) => (
 //             <label
 //               key={option}
 //               className="flex items-center gap-2 px-2 py-1 hover:bg-gray-100 cursor-pointer"
 ...
 //         <Button onClick={() => setAddDialogOpen(true)}>Add Order</Button>
 //       </div>
 //       {/* Filters */}
 ...
 //           onChange={(e) => setCustomerFilter(e.target.value)}
 //         />
 //         {/* Status multi-select dropdown with checkboxes */}
 //         <MultiSelectDropdown
 //           options={["OPEN", "PENDING", "INPROGRESS", "COMPLETED", "CANCELLED"]}
 //           selected={statusFilter}
 //           onChange={setStatusFilter}
 //         />
 //         {(searchTerm || customerFilter || statusFilter.length) && (
 //           <Button size="sm" variant="outline" onClick={clearFilters}>
 //             Clear Filters
 //           </Button>
 //         )}
 ...
 //         onPageChange={setPage}
 //         refreshData={fetchOrders}
 //         columns={getColumns(fetchOrders)}
 //         sortField={sortField}
 //         sortDir={sortDir}
 //         setSortField={setSortField}
 //         setSortDir={setSortDir}
 ...
 //     setLoading(true);
 //     try {
 //       const res = await getOrders(pageNumber, size, search, customer, statuses, sortBy, sortDirection);
 //       setOrders(res.data.items);
 //       setTotal(res.data.total);
 //       setPage(res.data.page);
 //     } catch {
 ...
 //           onChange={(e) => setCustomerFilter(e.target.value)}
 //         />
 //         {/* Status multi-checkbox dropdown */}
 //         <Popover>
 ...
 //   const [loading, setLoading] = useState(false);
 //   const [page, setPage] = useState(1);
 //   const [pageSize, setPageSize] = useState(10); // dynamic
 //   const [total, setTotal] = useState(0);
 //   const [addDialogOpen, setAddDialogOpen] = useState(false);
 //   const fetchOrders = async (pageNumber = page, size = pageSize) => {
 //     setLoading(true);
 //     try {
 //       const res = await getOrders(pageNumber, size);
 //       setOrders(res.data.items);
 //       setTotal(res.data.total);
 //       setPage(res.data.page);
 //     } catch {
 ...
 //         open={addDialogOpen}
 //         onClose={() => setAddDialogOpen(false)}
 //         refreshData={() => fetchOrders(1, pageSize)} // refresh from page 1
 //       />
 //       {/* Orders Table */}
 //       <OrdersTable
 //         data={orders}
 ...
 //   );
 // }
_s1(OrdersPage, "FjtkZLvcveuXdczyk8cuZ2+es00=");
_c1 = OrdersPage;
var _c, _c1;
...
//# sourceMappingURL=_62a344b6._.js.map